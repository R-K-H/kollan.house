    ...
    <Wrapper css={PageTemplate}>
      ...
      <main id="site-main" className="site-main" css={[SiteMain, outer]}>
        <article className="post page" css={[PostFull, NoImage]}>
          <PostFullHeader>
            <PostFullTitle>Resume</PostFullTitle>
          </PostFullHeader>
          ...
          <PostFullContent className="post-full-content">
            <div className="post-content">
              <h2>SUMMARY</h2>
              <p>
                Highly skilled in the technology industry with mastered abilities for strategic planning, team ­oriented project management, individual professional development and thoughtful leadership directed towards corporate success. Developed company recruitment, onboarding, training and culture processes and systems. With 10+ years experience building B2B solutions such as merchant services, applications, brand identity, marketing, business analysis, eCommerce, web and application development, print materials and event planning.
              </p>
              <h2>SKILLS</h2>
              <ul>
